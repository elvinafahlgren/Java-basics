...
public class PongGUI extends Application implements IEventHandler {
    ...
    private boolean running = false;    // Is game running?private final Paddle rightPaddle;
    ...
    private void keyPressed(KeyEvent event) {
        ...
        switch (kc) {
            case UP:
                // TODO
                pong.setSpeedRightPaddle(-Paddle.PADDLE_SPEED);
                break;
            case DOWN:
                // TODO
                pong.setSpeedRightPaddle(Paddle.PADDLE_SPEED);
            ...
            case Q:
                // TODO
                pong.setSpeedLeftPaddle(-Paddle.PADDLE_SPEED);
                break;
            case A:
                // TODO
                pong.setSpeedLeftPaddle(Paddle.PADDLE_SPEED);
    ...
    private void newGame() {
        ...
        // Build the model
        this.rightPaddle = new Paddle(Pong.GAME_WIDTH - Paddle.PADDLE_WIDTH, GAME_HEIGHT/2 - Paddle.PADDLE_HEIGHT/2); // Right paddle is located at the very right.
        this.leftPaddle = new Paddle(0, GAME_HEIGHT/2 - Paddle.PADDLE_HEIGHT/2);
        Ball ball = new Ball();
        Floor floor = new Floor();
        Ceiling ceiling = new Ceiling();
        pong = new Pong(ball, rightPaddle, leftPaddle, floor, ceiling); // Takes the created models and constructs a new Pong object.
